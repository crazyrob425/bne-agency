  ...
  return (
    ...
    >
      ...
      >
        {/* Front Face */}
        <div
          className="relative h-full overflow-hidden rounded-3xl border border-white/10 bg-[#0A0A0A] shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_20px_60px_rgba(0,0,0,0.6)] transition-all duration-500 hover:shadow-[0_0_0_1px_rgba(212,175,55,0.25),0_25px_80px_rgba(212,175,55,0.08)] cursor-pointer"
        ...
        >
          ...
          {/* Graphic Header */}
          <div className="relative h-40 overflow-hidden rounded-t-3xl bg-gradient-to-br from-[#111111] via-[#0A0A0A] to-[#141414]">
          ...
          <div className="relative p-5 space-y-4">
            <div>
              <h3 className="text-lg font-bold text-[#F4F4EE] leading-tight group-hover:text-[#D4AF37] transition-colors">
                {niche.keyword}
              </h3>
              <p className="text-[10px] uppercase tracking-[0.25em] text-[#666] font-bold mt-1">
                {niche.category}
              </p>
            </div>
