...
import { TrendingUp, Target, ArrowRight, Zap, BarChart3 } from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl font-display font-bold text-white leading-[1.1] mb-6">
              Traffic <span className="text-[oklch(0.78_0.16_85)]">Strategy</span>
            </h1>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-display font-bold text-white mb-4">
                The 2026 Traffic Playbook
              </h2>
              <p className="text-[oklch(0.7_0.012_85)] font-body leading-relaxed mb-6">
                From TikTok viral mechanics to Twitter/X algorithm hacks, we deploy compliant advertising and organic growth systems that build your audience month over month without violating platform terms.
              </p>
              {video && (
              ...
              {!video && (
                <div className="rounded-xl border-2 border-dashed border-[oklch(0.78_0.16_85/20%)] p-12 text-center text-[oklch(0.5_0.012_85)]">
                  Video asset not found. Please add What_services_should_a_firm_offer_creators_in_2026.mp4 to the media folder.
                </div>
              )}
            </div>
            <div className="space-y-6">
              <div className="luxury-card p-6 border border-[oklch(0.78_0.16_85/10%)]">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-white font-semibold">Organic Growth Systems</h3>
                </div>
                <p className="text-[oklch(0.65_0.012_85)] text-sm">Algorithm-friendly content strategies and post cadences that grow your account without paid spend.</p>
              </div>
              <div className="luxury-card p-6 border border-[oklch(0.78_0.16_85/10%)]">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-lg bg-[oklch(0.78_0.16_85/10%)] flex items-center justify-center text-[oklch(0.78_0.16_85)]">
                  ...
                  <h3 className="text-white font-semibold">Paid Media Management</h3>
                </div>
                <p className="text-[oklch(0.65_0.012_85)] text-sm">Platform-compliant ad campaigns on Twitter/X, Reddit, and traffic partners with real-time optimization.</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl font-display font-bold text-white mb-4">Traffic Is a System, Not a Gamble</h2>
            <p className="text-[oklch(0.7_0.012_85)] mb-8">BNE's traffic strategy turns random clicks into predictable revenue growth month after month.</p>
            <Link href="/apply">
              <motion.button whileTap={{ scale: 0.95 }} className="btn-gold px-10 py-3 text-sm">
                Apply for Traffic Strategy
              </motion.button>
            </Link>
          </motion.div>
        </div>
