 ...
 * Industry compliance standards and regulatory frameworks
 */
...
import { Shield, FileText, ArrowRight, Award } from "lucide-react";
...
export default function ComplianceStandards() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Seo
        title="Compliance Standards | BNE Agency"
        description="Understand the compliance standards governing the adult content industry. BNE keeps you compliant with federal, state, and platform regulations."
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl font-display font-bold text-white leading-[1.1] mb-6">
              Compliance <span className="text-[oklch(0.78_0.16_85)]">Standards</span>
            </h1>
            <p className="text-lg text-[oklch(0.7_0.012_85)] font-body leading-relaxed mb-8 max-w-2xl">
              The adult industry is heavily regulated. BNE ensures every creator we partner with meets or exceeds federal, state, and platform compliance requirements — without the headache.
            </p>
            <Link href="/apply">
              <motion.button whileTap={{ scale: 0.95 }} className="btn-gold px-8 py-3 text-sm">
                Get Compliance Protected
              </motion.button>
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl font-display font-bold text-white mb-4">Compliance Is a Competitive Advantage</h2>
            <p className="text-[oklch(0.7_0.012_85)] mb-8">Creators who stay compliant outlast the competition. Let BNE handle the legal complexity so you can focus on growth.</p>
            <Link href="/apply">
              <motion.button whileTap={{ scale: 0.95 }} className="btn-gold px-10 py-3 text-sm">
                Apply for Compliance Support
              </motion.button>
            </Link>
          </motion.div>
        </div>
