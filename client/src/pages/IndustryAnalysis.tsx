 ...
 * Deep-dive industry reports and market intelligence
 */
...
import { Layers, TrendingUp, BarChart3, ArrowRight, Crown } from "lucide-react";
...
export default function IndustryAnalysis() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Seo
        title="Industry Analysis | Blacklisted University"
        description="In-depth industry reports and market analysis for adult content creators. Understand trends, revenue models, and competitive landscapes."
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="heading-xl text-[oklch(0.94_0.01_85)] mb-4 max-w-4xl mx-auto">
              Industry <span className="gradient-text-gold">Analysis</span>
            </h1>
            <p className="text-[oklch(0.65_0.012_85)] text-lg max-w-3xl mx-auto mb-8 font-body leading-relaxed">
              Data-driven market intelligence on platform economics, creator earnings, audience behavior, and competitive positioning — exclusive to BNE partners.
            </p>
            <Link href="/university">
              <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-full btn-gold text-sm font-semibold">
                <Layers size={16} /> Enter Intelligence Hub <ArrowRight size={14} />
              </motion.button>
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="text-[oklch(0.78_0.16_85)] text-xs font-bold font-mono-lux tracking-widest uppercase">Marketing Assets & Reports</span>
            <h2 className="text-3xl font-bold text-white mt-3 mb-4 font-display">Marketing Assets Pack</h2>
          </div>
          {assets && (
            <motion.div
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-semibold">Marketing Assets Pack</h3>
                  <p className="text-[oklch(0.65_0.012_85)] text-sm">Click to view the full industry assets pack</p>
                </div>
              </div>
            </motion.div>
          )}
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            ...
            <p className="text-[oklch(0.7_0.012_85)] mb-8">BNE's industry analysis gives you the competitive edge. Apply for intelligence access.</p>
            <Link href="/apply">
