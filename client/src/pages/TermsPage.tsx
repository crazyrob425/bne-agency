/**
 * BNE Terms Page
 * Terms of service and legal terms overview
 */
...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Seo
        title="Terms | BNE Agency"
        description="Terms of service and legal terms for BNE's creator management and advisory services."
        canonical="/terms"
      />
      <Navigation />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl font-display font-bold text-white leading-[1.1] mb-6">
              Terms of <span className="text-[oklch(0.78_0.16_85)]">Service</span>
            </h1>
            <p className="text-lg text-[oklch(0.7_0.012_85)] font-body leading-relaxed mb-8 max-w-2xl">
              Clear, transparent terms of service for every BNE engagement. We believe you should know exactly what you're signing up for — no fine print surprises.
            </p>
            <Link href="/apply">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl font-display font-bold text-white mb-4">Transparent Terms, No Surprises</h2>
            <p className="text-[oklch(0.7_0.012_85)] mb-8">Apply to BNE and review the exact terms of your partnership before you commit.</p>
            <Link href="/apply">
