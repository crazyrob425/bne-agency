 ...
 * Financial privacy, encrypted data, and information security
 */
...
export default function DataProtection() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Seo
        title="Data Protection | BNE Agency"
        description="Comprehensive data protection and financial privacy systems. Encrypted storage, anonymous business structures, and information security for creators."
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl font-display font-bold text-white leading-[1.1] mb-6">
              Data <span className="text-[oklch(0.78_0.16_85)]">Protection</span>
            </h1>
            <p className="text-lg text-[oklch(0.7_0.012_85)] font-body leading-relaxed mb-8 max-w-2xl">
              Every digital footprint is a liability. We design and deploy data protection systems that encrypt, anonymize, and secure every piece of information flowing through your brand.
            </p>
            <Link href="/apply">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-display font-bold text-white mb-4">The Invisible Identity Digital Fortress</h2>
              <p className="text-[oklch(0.7_0.012_85)] font-body leading-relaxed mb-6">
                Learn how BNE builds a complete anonymity firewall around your creator brand — from encrypted email and VOIP to anonymous LLC structuring and offshore payment rails.
              </p>
              {video && (
            ...
            <div className="space-y-6">
              ...
              <div className="luxury-card p-6 border border-[oklch(0.78_0.16_85/10%)]">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-white font-semibold">Encrypted Operations</h3>
                </div>
                <p className="text-[oklch(0.65_0.012_85)] text-sm">End-to-end encryption for all business communications, file storage, and financial records.</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl font-display font-bold text-white mb-4">Your Data Should Be Invisible</h2>
            <p className="text-[oklch(0.7_0.012_85)] mb-8">Apply to BNE and get enterprise-grade data protection for your creator business.</p>
            <Link href="/apply">
